...
public final class TrustTokenKeyCommitmentResult extends org.chromium.mojo.bindings.Struct {
    ...
    public static TrustTokenKeyCommitmentResult decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new TrustTokenKeyCommitmentResult(elementsOrVersion);
                ...
                result.protocolVersion = decoder0.readInt(12);
                ...
                result.batchSize = decoder0.readInt(20);
                }
                {
                ...
                result.unavailableLocalOperationFallback = decoder0.readInt(40);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.protocolVersion, 12);
        
        encoder0.encode(this.id, 16);
        
        encoder0.encode(this.batchSize, 20);
        ...
        encoder0.encode(this.unavailableLocalOperationFallback, 40);
    }
}