// BitmapMappedFromTrustedProcess.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class BitmapMappedFromTrustedProcess extends org.chromium.mojo.bindings.Struct {
    ...
    public static BitmapMappedFromTrustedProcess deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static BitmapMappedFromTrustedProcess deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static BitmapMappedFromTrustedProcess decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        BitmapMappedFromTrustedProcess result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new BitmapMappedFromTrustedProcess(elementsOrVersion);
                {
