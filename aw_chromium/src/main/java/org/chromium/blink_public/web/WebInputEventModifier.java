...
@IntDef({
    ...
    WebInputEventModifier.TARGET_FRAME_MOVED_RECENTLY_FOR_I_OV2,
...
public @interface WebInputEventModifier {
  ...
  /**
   * TODO(szager): This is the same as TARGET_FRAME_MOVED_RECENTLY, but it overrides that value for
   * iframes that are using IntersectionObserver V2 features (i.e. occlusion detection). The purpose
   * of this distinction is to preserve existing behavior for IOv2-using iframes while dialing in
   * the feature parameters for kDiscardInputEventsToRecentlyMovedFrames, which is broader in scope.
   * At the end of that process, this flag should be removed in favor of
   * TARGET_FRAME_MOVED_RECENTLY.
   */
  int TARGET_FRAME_MOVED_RECENTLY_FOR_I_OV2 = 1 << 25;
  /**
   ...
   */
  int SCROLLBAR_MANIPULATION_HANDLED_ON_COMPOSITOR_THREAD = 1 << 26;
  /**
