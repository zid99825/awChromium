...
public @interface PageTransition {
   ...
   * separate frame, so may not care about the URL (see MANUAL below). All Fenced Frame navigations
   * will be of this type because they are considered a non-toplevel navigation that does not
   ...
   * qualifiers further define the transition. The values 0x00200000 (FROM_API_3) and 0x00400000
   * (FROM_API_2) were used for experiments and were removed around 6/2021. The experiments ended
   * well before 6/2021, but it's possible some databases still have the values. See
   * https://crbug.com/1141501 for more. A managed user attempted to visit a URL but was blocked.
   */
   ...
   */
  int SERVER_REDIRECT = -2147483648;
  /**
   * Used to test whether a transition involves a redirect.
   */
  int IS_REDIRECT_MASK = -1073741824;
  /**
   * General mask defining the bits used for the qualifiers.
   */
  int QUALIFIER_MASK = -256;
}
