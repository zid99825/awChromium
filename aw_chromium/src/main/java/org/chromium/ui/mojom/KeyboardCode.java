// KeyboardCode.java is auto generated by mojom_bindings_generator.py, do not edit
...
// For:
//     ui/events/mojom/keyboard_codes.mojom
//
...
public final class KeyboardCode {
    ...
    @IntDef({
        ...
        KeyboardCode.RETURN,
        KeyboardCode.SHIFT,
        KeyboardCode.CONTROL,
        KeyboardCode.MENU,
        KeyboardCode.PAUSE,
        KeyboardCode.CAPITAL,
        KeyboardCode.KANA,
        KeyboardCode.HANGUL,
        KeyboardCode.JUNJA,
        KeyboardCode.FINAL,
        ...
        KeyboardCode.KANJI,
        KeyboardCode.ESCAPE,
        KeyboardCode.CONVERT,
        KeyboardCode.NONCONVERT,
        KeyboardCode.ACCEPT,
        KeyboardCode.MODECHANGE,
        KeyboardCode.SPACE,
        KeyboardCode.PRIOR,
        KeyboardCode.NEXT,
        KeyboardCode.END,
        ...
        KeyboardCode.SNAPSHOT,
        KeyboardCode.INSERT,
        KeyboardCode.DELETE_KEY,
        KeyboardCode.HELP,
        KeyboardCode.NUM_0,
        KeyboardCode.NUM_1,
        KeyboardCode.NUM_2,
        ...
        KeyboardCode.MULTIPLY,
        KeyboardCode.ADD,
        KeyboardCode.SEPARATOR,
        KeyboardCode.SUBTRACT,
        KeyboardCode.DECIMAL,
        KeyboardCode.DIVIDE,
        KeyboardCode.F1,
        KeyboardCode.F2,
        KeyboardCode.F3,
        ...
        KeyboardCode.LSHIFT,
        KeyboardCode.RSHIFT,
        KeyboardCode.LCONTROL,
        KeyboardCode.RCONTROL,
        KeyboardCode.LMENU,
        KeyboardCode.RMENU,
        KeyboardCode.BROWSER_BACK,
        KeyboardCode.BROWSER_FORWARD,
        KeyboardCode.BROWSER_REFRESH,
        KeyboardCode.BROWSER_STOP,
        KeyboardCode.BROWSER_SEARCH,
        KeyboardCode.BROWSER_FAVORITES,
        KeyboardCode.BROWSER_HOME,
        KeyboardCode.VOLUME_MUTE,
        KeyboardCode.VOLUME_DOWN,
        KeyboardCode.VOLUME_UP,
        KeyboardCode.MEDIA_NEXT_TRACK,
        KeyboardCode.MEDIA_PREV_TRACK,
        KeyboardCode.MEDIA_STOP,
        KeyboardCode.MEDIA_PLAY_PAUSE,
        KeyboardCode.MEDIA_LAUNCH_MAIL,
        KeyboardCode.MEDIA_LAUNCH_MEDIA_SELECT,
        KeyboardCode.MEDIA_LAUNCH_APP1,
        KeyboardCode.MEDIA_LAUNCH_APP2,
        KeyboardCode.OEM_1,
        KeyboardCode.OEM_PLUS,
        KeyboardCode.OEM_COMMA,
        KeyboardCode.OEM_MINUS,
        KeyboardCode.OEM_PERIOD,
        KeyboardCode.OEM_2,
        KeyboardCode.OEM_3,
        KeyboardCode.OEM_4,
        KeyboardCode.OEM_5,
        ...
        KeyboardCode.OEM_7,
        KeyboardCode.OEM_8,
        KeyboardCode.OEM_102,
        KeyboardCode.PROCESSKEY,
        KeyboardCode.PACKET,
        KeyboardCode.DBE_SBCSCHAR,
        KeyboardCode.DBE_DBCSCHAR,
        KeyboardCode.ATTN,
        KeyboardCode.CRSEL,
        KeyboardCode.EXSEL,
        KeyboardCode.EREOF,
        ...
        KeyboardCode.NONAME,
        KeyboardCode.PA1,
        KeyboardCode.OEM_CLEAR,
        KeyboardCode.UNKNOWN,
        KeyboardCode.WLAN,
        KeyboardCode.POWER,
        KeyboardCode.ASSISTANT,
        KeyboardCode.BRIGHTNESS_DOWN,
        KeyboardCode.BRIGHTNESS_UP,
        KeyboardCode.KBD_BRIGHTNESS_DOWN,
        KeyboardCode.KBD_BRIGHTNESS_UP,
        KeyboardCode.ALTGR,
