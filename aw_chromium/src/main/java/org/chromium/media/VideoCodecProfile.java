...
@IntDef({
    ...
    VideoCodecProfile.HEVCPROFILE_EXT_MAX, VideoCodecProfile.VVCPROFILE_MIN,
    VideoCodecProfile.VVCPROFILE_MAIN10, VideoCodecProfile.VVCPROFILE_MAIN12,
    VideoCodecProfile.VVCPROFILE_MAIN12_INTRA, VideoCodecProfile.VVCPROIFLE_MULTILAYER_MAIN10,
    VideoCodecProfile.VVCPROFILE_MAIN10_444, VideoCodecProfile.VVCPROFILE_MAIN12_444,
    VideoCodecProfile.VVCPROFILE_MAIN16_444, VideoCodecProfile.VVCPROFILE_MAIN12_444_INTRA,
    VideoCodecProfile.VVCPROFILE_MAIN16_444_INTRA,
    VideoCodecProfile.VVCPROFILE_MULTILAYER_MAIN10_444,
    VideoCodecProfile.VVCPROFILE_MAIN10_STILL_PICTURE,
    VideoCodecProfile.VVCPROFILE_MAIN12_STILL_PICTURE,
    VideoCodecProfile.VVCPROFILE_MAIN10_444_STILL_PICTURE,
    VideoCodecProfile.VVCPROFILE_MAIN12_444_STILL_PICTURE,
    VideoCodecProfile.VVCPROFILE_MAIN16_444_STILL_PICTURE, VideoCodecProfile.VVCPROFILE_MAX,
...
public @interface VideoCodecProfile {
  ...
  int VVCPROFILE_MIN = 37;
  int VVCPROFILE_MAIN10 = VVCPROFILE_MIN;
  int VVCPROFILE_MAIN12 = 38;
  int VVCPROFILE_MAIN12_INTRA = 39;
  int VVCPROIFLE_MULTILAYER_MAIN10 = 40;
  int VVCPROFILE_MAIN10_444 = 41;
  int VVCPROFILE_MAIN12_444 = 42;
  int VVCPROFILE_MAIN16_444 = 43;
  int VVCPROFILE_MAIN12_444_INTRA = 44;
  int VVCPROFILE_MAIN16_444_INTRA = 45;
  int VVCPROFILE_MULTILAYER_MAIN10_444 = 46;
  int VVCPROFILE_MAIN10_STILL_PICTURE = 47;
  int VVCPROFILE_MAIN12_STILL_PICTURE = 48;
  int VVCPROFILE_MAIN10_444_STILL_PICTURE = 49;
  int VVCPROFILE_MAIN12_444_STILL_PICTURE = 50;
  int VVCPROFILE_MAIN16_444_STILL_PICTURE = 51;
  int VVCPROFILE_MAX = VVCPROFILE_MAIN16_444_STILL_PICTURE;
  int VIDEO_CODEC_PROFILE_MAX = VVCPROFILE_MAIN16_444_STILL_PICTURE;
}
