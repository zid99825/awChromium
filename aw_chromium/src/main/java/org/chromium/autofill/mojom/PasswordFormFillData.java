...
public final class PasswordFormFillData extends org.chromium.mojo.bindings.Struct {
    ...
    public static PasswordFormFillData decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new PasswordFormFillData(elementsOrVersion);
                ...
                result.usernameElementRendererId = FieldRendererId.decode(decoder1);
                }
                {
                    
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(32, false);
                result.passwordElementRendererId = FieldRendererId.decode(decoder1);
                }
                {
                    
                result.usernameMayUsePrefilledPlaceholder = decoder0.readBoolean(40, 0);
                }
                {
                    
                result.waitForUsername = decoder0.readBoolean(40, 1);
                }
                {
                    
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(48, false);
                result.preferredLogin = PasswordAndMetadata.decode(decoder1);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.usernameElementRendererId, 24, false);
        
        encoder0.encode(this.passwordElementRendererId, 32, false);
        
        encoder0.encode(this.usernameMayUsePrefilledPlaceholder, 40, 0);
        
        encoder0.encode(this.waitForUsername, 40, 1);
        
        encoder0.encode(this.preferredLogin, 48, false);
        
        if (this.additionalLogins == null) {
            encoder0.encodeNullPointer(56, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.additionalLogins.length, 56, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
